...
// @Param data body system.Users true "创建users表"
...
// @Accept application/json
// @Produce application/json
// @Param data body system.Users true "删除users表"
...
// @Accept application/json
// @Produce application/json
// @Param data body system.Users true "更新users表"
...
// @Success 200 {object} response.Response{data=system.Users,msg=string} "查询成功"
...
// @Accept application/json
// @Produce application/json
// @Param data query systemReq.UsersSearch true "分页获取users表列表"
...
func (usersApi *UsersApi) GetUsersList(c *gin.Context) {
	...
	var pageInfo systemReq.UsersSearch
