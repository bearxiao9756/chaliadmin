...
var (
	...
	draftsApi                    = api.ApiGroupApp.SystemApiGroup.TeamDraftsApi
	teamchalibotsApi             = api.ApiGroupApp.SystemApiGroup.TeamChaliBotsApi
	TeamChalibotCommandsApi      = api.ApiGroupApp.SystemApiGroup.TeamChaliBotCommandsApi
)
